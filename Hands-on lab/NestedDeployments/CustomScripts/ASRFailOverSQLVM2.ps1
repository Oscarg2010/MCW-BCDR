...
.What calls this script?
 ...
 - This file will be run as a Custom Script Extention on the SQLVM2 box which is in the Primary Site,
...
#>
Import-Module sqlps
$DBPath = "SQLSERVER:\Sql\SQLVM2\DEFAULT\AvailabilityGroups\BCDRAOG\AvailabilityDatabases"
